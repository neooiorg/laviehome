  ...
  return (
    <div className="space-y-4 rounded-xl border bg-muted/20 p-4">
      <div className="flex items-start gap-3">
        ...
        <div><p className="font-semibold">{mode === "custom" ? "Chọn phòng và ngày còn trống" : "Chọn khung giờ còn trống"}</p><p className="mt-1 text-xs leading-5 text-muted-foreground">{mode === "custom" ? "Bấm vào một ô màu xanh trong mỗi phòng/ngày muốn áp dụng khoảng giờ tùy chỉnh." : "Bấm vào ô màu xanh để chọn khung giờ cho booking."}</p></div>
      </div>
